...
parser.add_argument(
    "--in_file", default="val224_compressed.pkl", help="input file path"
)
parser.add_argument(
    "--out_root",
    default="/data/public_dataset/pytorch/imagenet-data/",
...
data_dict299 = dict(data=np.array(data299).transpose(0, 3, 1, 2), target=d["target"])
...
data_dict224 = dict(data=np.array(data224).transpose(0, 3, 1, 2), target=d["target"])
